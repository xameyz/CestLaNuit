...
public class isWaypointsAroundClick {
	...
	public HashSet<DefaultWaypoint >isWaypointsAroundClick(Map _map, Point _mousePosition) {
		...
		//coordonnées du polygone : bas gauche, bas droite, haut gauche, haut droite, en fonction du clic
		//la hauteur et la largeur sont brutes et non logiques
		//il s'agit de mesures faites lors de tests, qui se rapprochent le plus de l'image du waypoint sur la carte
		...
		//création d'un tableau répertoriant les coordonnées dans l'ordre de création du polygone
		...
		//pour chaque waypoint apparaissant sur la carte, on va voir si l'un deux est situé dans le polygone
